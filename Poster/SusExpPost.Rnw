...
\title{\veryHuge The Association of Crime Occurrence on Rates of Suspensions and Expulsions in Chicago Public Schools Using Poisson Regression}
...
\bf Count Data Modelled Using a Poisson Distribution
\vspace {.5mm}
\begin{equation} y_{i} {\raise.17ex\hbox{$\scriptstyle\sim$}} Poisson(\lambda)
\end{equation}
...
\begin{equation} 
  \begin{aligned}
    log(\mu_{i}) = log(n_{i}) + \alpha_{i} + \textbf{X}\beta \\
    \textbf{X}\beta = \beta_{0} + X_{1}\beta_{1} + ... + X_{n}\beta_{j}
  \end{aligned}
\end{equation}
\end{block}
%\vfill
...
\begin{figure}[h]
\begin{tabular}{ll}
\includegraphics[width=12cm,scale=1]{C:/Users/Nick/Documents/educrime/Nick/ES_Crime.png}
&
\includegraphics[width=12cm,scale=1]{C:/Users/Nick/Documents/educrime/Nick/HS_Crime.png}
\end{tabular}
...
\begin{figure}[h]
\begin{tabular}{ll}
\includegraphics[width=12cm,scale=1]{C:/Users/Nick/Documents/educrime/Nick/ES_Expulsions.png}
&
\includegraphics[width=12cm,scale=1]{C:/Users/Nick/Documents/educrime/Nick/HS_Expulsions.png}
\end{tabular}
...
\textbf {Elementary School and Crime Frequencies}
...
\textbf {High School and Crime Frequencies}
...
\begin{itemize}
  ...
  \item Spatial Random Effects
    \begin{itemize}
      \item This variable examined whether the occurance of a crime in one school boundary influenced crime in a neighboring school boundary
