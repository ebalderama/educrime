...
\begin{figure}[h]
\begin{tabular}{ll}
\includegraphics[width=7cm,scale=1]{C:/Users/Nick/Documents/educrime/Poster/Nick Presentation figures/ES_exp_hist.png}
&
\includegraphics[width=7cm,scale=1]{C:/Users/Nick/Documents/educrime/Poster/Nick Presentation figures/ES_exp_plot.png}
\end{tabular}
...
\begin{figure}[h]
\begin{tabular}{ll}
\includegraphics[width=7cm,scale=1]{C:/Users/Nick/Documents/educrime/Poster/Nick Presentation figures/ES_sus_hist.png}
&
\includegraphics[width=7cm,scale=1]{C:/Users/Nick/Documents/educrime/Poster/Nick Presentation figures/ES_sus_plot.png}
\end{tabular}
...
\begin{figure}[h]
\begin{tabular}{ll}
\includegraphics[width=7cm,scale=1]{C:/Users/Nick/Documents/educrime/Poster/Nick Presentation figures/HS_exp_hist.png}
&
\includegraphics[width=7cm,scale=1]{C:/Users/Nick/Documents/educrime/Poster/Nick Presentation figures/HS_exp_plot.png}
\end{tabular}
...
\begin{figure}[h]
\begin{tabular}{ll}
\includegraphics[width=7cm,scale=1]{C:/Users/Nick/Documents/educrime/Poster/Nick Presentation figures/HS_sus_hist.png}
&
\includegraphics[width=7cm,scale=1]{C:/Users/Nick/Documents/educrime/Poster/Nick Presentation figures/HS_sus_plot.png}
\end{tabular}
\caption{Suspension Models for High Schools}
\end{figure}

\begin{itemize}
  \item \textbf{Interpretation Example:} A parameter estimate of 7.25 has a 1408 multiplicative effect on the mean number of suspensions
\end{itemize}
...
\begin{itemize}
  ...
  \item Misconducts
    \begin{itemize}
      ...
      \ This is expected, as with the more misconducts we expect more suspensions and expulsions 
    \end{itemize}
  ...
  \item Violent Crime Frequency
    \begin{itemize}
      \item Crime frequency was found to be significant for both suspensions and expulsions for most of the models
      \item For most cases, it was found to be a positive relationship between the amount violent crime and the number of suspension and expulsions
    \end{itemize}
    
  \item Spatial Random Effects
    \begin{itemize}
      \item This variable examined whether the occurance of a suspension or expulsion at a school affects a neighboring school
