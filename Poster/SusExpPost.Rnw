...
\begin{itemize}
  \item \textbf{Interpretation Example:} A parameter estimate of -0.52 has a .594 multiplicative effect on the probability of a zero count for high school suspensions
\end{itemize}
